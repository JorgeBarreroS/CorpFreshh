    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            ...
            <div class="container-fluid">
                ...
                <main >
                    <h2 class="text-center mt-4" >Registro de Ordenes </h2>
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-4">
                            <form action="../controladores/controlador.orden.php" method="POST">
                                ...
                                <label for="">Fecha A-M-D</label>
                                <input type="text" name="fecha_venta" class="form-control">
                                <br>
                                <label for="">Impuesto</label>
                                <input type="text" name="impuesto_venta" class="form-control">
                                <br>
